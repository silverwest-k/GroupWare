...
function ReportDocument() {
    ...
    const rows = [
        createData('2023-06-20', "휴가신청서", "근태관련 신청서", 24),
        createData('2023-06-15', "지출결의서", "비품 구매 요청서", 37),
        createData('2023-06-05', "외근신청서", "근태관련 신청서", 24),
        createData('2023-05-30', "휴가신청서", "근태관련 신청서", 67),
        createData('2023-05-24', "업무협조", "사원증 신청서", 49)
    ];
