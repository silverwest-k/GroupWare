...
// 문서양식 API
export const CATEGORY_CREATE_API ="/admin/templates/create" // 양식 생성 (o)
export const CATEGORY_DELETE_API = "/admin/templates/delete"  // (+id) 양식 삭제 (o)
export const CATEGORY_LIST_API = "/templates/list"  // 양식 리스트 조회 (o)
export  const SHOW_CATEGORY_API="/templates" // (+id) 양식 데이터 조회 (o)
